					...
					<div class="lw_contact_form">
						...
						<form action="<%=request.getContextPath()%>/RequestLawyerController" method="post">
							...
							<c:forEach items="${sessionScope.clientRequestList }" var="i">
								...
								<textarea name="requestDescription" class="contact_input" required id="mesg">${i.requestDescription }</textarea>
								</div>
										...
										<input type="hidden" name="flag" value="insertRejectRequestDescription">
							
							</c:forEach>		
							
							<div class="col-lg-\10 col-md-10 col-sm-10" style="margin-top: 5%">
							<textarea name="rejectRequestDescription" class="contact_input" placeholder="Write a Reject Request Description*" required id="mesg"></textarea>
							</div>
