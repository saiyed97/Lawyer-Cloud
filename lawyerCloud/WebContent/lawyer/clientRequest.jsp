				...
				<div class="col-lg-15 col-md-15 col-sm-15">
					...
					<table border="1" class="table">
										...
										<tr>
											...
											<c:set var="k" value="${i.requestReplyDescription}"></c:set>
											<c:if test="${fn:length(k) eq 0}">
											<td>
												<a href="<%=request.getContextPath()%>/RequestLawyerController?flag=acceptRequest&requestId=${i.requestLawyerId }&clientEmailId=${i.loginVO.email}">ACCEPT</a> /
												<a href="<%=request.getContextPath()%>/RequestLawyerController?flag=rejectRequest&requestId=${i.requestLawyerId }&clientEmailId=${i.loginVO.email}">REJECT</a> 
											</td>
											</c:if>
