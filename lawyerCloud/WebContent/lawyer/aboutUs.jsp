...
<body>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="about_left_part">
						<p style="text-align: justify;"> With ongoing trainings and education, our staff is here to help you create a website that will stand out and meet all standards for lawyer websites. Our staff is prepared to offer advice and counsel to assure that the project stays on track. The staff is not afraid to tell you if a design or marketing idea will have a negative affect on your website. Our staff members will always explain why a particular idea doesn't work and provide alternative solutions. We will work together to create the best website to meet your needs. We measure our success by our client satisfaction. </p>
						<div class="lw_about_quote">
							<div class="inner_quote" style="text-align: justify;"> Lawyers are the key point in our portal by creating an account, they can easily get clients. It is also feasible for Clients to consult Lawyers immediately by browsing Lawyers profiles. </div>
						</div>
						<p style="text-align: justify;"> The success of our portal is directly connected to the success of our clients. Our clients many times will not have a full technical understanding of websites and search engine optimization but they should always be informed, understand the direction of the project and feel they can ask questions on any level of understanding. </p>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="about_right_part">
						<ul class="thumbnail_slider">
							<li> <img src="images/about-img.png" class="img-responsive" alt="slide" /> </li>
							<li> <img src="images/thumbslide2.png" class="img-responsive" alt="slide" /> </li>
							<li> <img src="images/about-img.png" class="img-responsive" alt="slide" /> </li>
						</ul>
						<div class="full_width">
							<div id="bx-pager">
								<div class="col-lg-4  col-md-4 col-sm-4 col-xs-4">
									<a data-slide-index="0" href=""> <img src="images/slide-thumb2.jpg" alt="thumb" /> </a>
								</div>
								<div class="col-lg-4  col-md-4 col-sm-4 col-xs-4">
									<a data-slide-index="1" href=""> <img src="images/slide-thumb1.jpg" alt="thumb" /> </a>
								</div>
								<div class="col-lg-4  col-md-4 col-sm-4 col-xs-4">
									<a data-slide-index="2" href=""> <img src="images/slide-thumb2.jpg" alt="thumb" /> </a>
								</div>
							</div>
						</div>
					</div>
	...
	<!-- <div class="wrapper_main lw_mission_section history_bg_blue">
		<div class="container">
			<div class="row">
				...
				<div class="full_width">
					<div class="col-lg-6 col-md-6 col-sm-12">
						<div class="left_side_vision_img"> <img src="images/vision_img.png" class="img-responsive" alt=""> </div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12">
						<div class="lw_mission_lists">
							<ul>
								<li> Nullam eu neque vel purus lacinia feugiat. </li>
								<li> Vestibulum aliquet elit sed augue posuere mollis. </li>
								<li> Vestibulum non est consequat, bibendum turpis vitae, hendrerit leo. </li>
								<li> Pellentesque a nulla auctor neque tincidunt pretium. </li>
								<li> in nec diam vulputate, tempus urna quis, tincidunt velit. </li>
								<li> Donec non urna scelerisque, rhoncus dui nec, cursus quam. </li>
								<li> Quisque consequat orci id elit fringilla, ut accumsan turpis commodo. </li>
								<li> Integer a ex porttitor, posuere erat id, consequat neque. </li>
							</ul>
							<div class="read_more_orange"> <a href="#">
										contact us
									</a> </div>
						</div>
					</div>
	...
	<!-- <div class="wrapper_main about_client_section">
		<div class="container">
			<div class="row">
				first counter start
				<div class="col-lg-4 col-md-4 col-sm-4">
					counter wrapper start
					<div class="full_width lw_count_wrap">
						<div class="counter_wrapper_second">
	...
	<!-- Crousel Section End-->
	<!-- <div class="wrapper_main lw_crousel_section bg_white">
		<div class="container">
			<div class="row">
				<div class="col-lg-10 col-md-10 col-sm-10 col-lg-offset-1 col-md-offset-1 col-sm-offset-1">
					<div class="crousel_items item_blur">
						<div class="item"> <img src="images/logo1.png" alt=""> </div>
						<div class="item"> <img src="images/logo2.png" alt=""> </div>
						<div class="item"> <img src="images/logo3.png" alt=""> </div>
						<div class="item"> <img src="images/logo4.png" alt=""> </div>
						<div class="item"> <img src="images/logo5.png" alt=""> </div>
						<div class="item"> <img src="images/logo1.png" alt=""> </div>
						<div class="item"> <img src="images/logo2.png" alt=""> </div>
					</div>
				</div>
