	...
	<div class="wrapper_main lw_header_banner">
				...
				<div class="col-lg-3 col-md-3 col-sm-6" style="margin-top: 5%;margin-bottom: 5%;margin-left: 35%">
					<div class="attorney_img_wrap attorney_second_wrap">
						<div class="attorney_img"><img src="<%=request.getContextPath()%>/doc/${z.fileName}" style="width:300px;height:300px" alt="image" id="img"/>
						...
						<div class="hw_thumb_title">
							...
							<form style="display:none" method="post" action="<%=request.getContextPath()%>/LawyerRegisterController" enctype="multipart/form-data">
							<p><input type="file" name="file" class=""  required id="mesg"></p>
							<input type="hidden" name="flag" value="changeImage">
							<input type="submit" value="Change">
							</form>
							<p>&nbsp;</p>
							<div class="overlay_social">
									<a href="<%=request.getContextPath()%>/LawyerRegisterController?flag=editProfile" title="Edit Profile"> <i class="fa fa-edit">
										</i></a>
									<a href="<%=request.getContextPath()%>/LawyerRegisterController?flag=changePassword" title="Change password"> <i class="fa fa-expeditedssl">
										</i></a>
									<a href="<%=request.getContextPath()%>/LawyerRegisterController?flag=changeImage" title="Change profile image"> <i class="fa fa-file-image-o">
										</i></a>	
								</div>
