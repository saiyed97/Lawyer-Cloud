...
<body>
	...
	<!-- Our Attorneys Section start-->			
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12" style="margin-top: 5%">
				...
				<div class="col-lg-3 col-md-3 col-sm-6" style="margin-top: 4%">
					<div class="attorney_img_wrap attorney_second_wrap">
						<div class="attorney_img"> <img src="<%=request.getContextPath()%>/doc/${z.fileName}" style="width:300px;height:300px" class="img-responsive" alt=""/>
							
						</div>
						<div class="hw_thumb_title">
							<h5>
									<a href="#">${z.firstName} ${z.lastName}</a>
								</h5>
							<p>${z.qualification }</p>
