		...
		<div class="container">
			<div class="row">
				...
				<div class="lw_contact_form">
					<form name="test" method="post" action="<%=request.getContextPath()%>/ClientRegisterController" enctype="multipart/form-data">
						...
						<div class="col-lg-6 col-md-6 col-sm-6">
							<input type="number" name="mobileNumber" placeholder="Enter 10 digit Mobile Number*" maxlength="10" class="contact_input" required id="uphone"/> </div>		
