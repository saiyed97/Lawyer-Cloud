                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title"><b>View SubCategory</b></h4>
                                    ...
                                    <table id="datatable" class="table table-bordered">
										...
										<tr>
											...
											<td>
												<a href="<%=request.getContextPath()%>/SubCategoryController?flag=deleteSubCategory&subCategoryId=${i.subCategoryId}">DELETE</a> /
												<a href="<%=request.getContextPath()%>/SubCategoryController?flag=editSubCategory&subCategoryId=${i.subCategoryId}">EDIT</a> 
											</td>
