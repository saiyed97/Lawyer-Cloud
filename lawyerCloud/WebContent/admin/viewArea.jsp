                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">View Area</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title"><b>View Area</b></h4>
                                    ...
                                    <table id="datatable" class="table table-bordered">
										...
										<tr>
											...
											<td>
												<a href="<%=request.getContextPath()%>/AreaController?flag=deleteArea&areaId=${i.areaId}">DELETE</a> /
												<a href="<%=request.getContextPath()%>/AreaController?flag=editArea&areaId=${i.areaId}">EDIT</a> 
											</td>
