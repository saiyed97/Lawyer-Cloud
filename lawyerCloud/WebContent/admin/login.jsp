...
<body>
	...
	<jsp:include page="/user/header1.jsp"></jsp:include>
		...
		<div class="container">
			...
			<div class="col-md-6">
				...
				<div class="lw_contact_form">
					<form method="post" action="abcd">
						
						
						<div class="col-lg-12 col-md-12 col-sm-12" style="margin-top: 3%">
						
							<input name="emailId" type="email" id="emailaddress" required="required" placeholder="Enter your email" class="contact_input"/> </div>
								
							
						<div class="col-lg-12 col-md-12 col-sm-12" style="margin-top: 3%">
						
							<input type="password" name="password" required="required" id="password" placeholder="Enter your password"  class="contact_input"/> </div>							
					...
					<a href="<%=request.getContextPath()%>/ContactUsController?flag=forgotPassword" style="margin-right:15px" class="pull-right">forgot password</a>
	...
	<jsp:include page="/user/footer1.jsp"></jsp:include>
