                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">View Testimonial</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title"><b>View Testimonial</b></h4>
                                    ...
                                    <table id="datatable" class="table table-bordered">
                                        ...
                                        <c:forEach items="${sessionScope.testimonialList}" var="i">
										...
										<tr>
											...
											<td>${i.testimonialDescription}</td>
											<td>${i.dateAndTime}</td>
											<%-- <td>${i.testimonialStatus}</td> --%>
