                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Add State</h4>
                                ...
                                <div class="card-box">
                                    ...
                                    <form method="post" action="<%=request.getContextPath()%>/StateController">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="pass1" type="text" name="stateName" placeholder="Enter State Name" required
                                                   class="form-control">
                                        </div>
										
										<input type="hidden" name="flag" value="addState">	
