				...
				<!-- <div class="col-lg-12 col-md-12 col-sm-12">
					...
					<div class="col-lg-6 col-md-6 col-sm-6"> -->
						...
						<form action="<%=request.getContextPath()%>/RequestLawyerController" method="post">
							...
							<input type="number" name="mobileNumber" class="contact_input" maxlength="10" required="required" placeholder="Contact Number*"/>
							</div>
							
							<div class="col-lg-10 col-md-10 col-sm-10" style="margin-top: 5%">
							<textarea name="requestDescription" class="contact_input" required="required" placeholder="Write a Request Description*" id="mesg"></textarea>
							</div>
															
													
						<input type="hidden" name="flag" value="insertRequestDescription">	
							
							<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="submit-btn-frm col-lg-12" >
								<input type="submit" value="Request" class="submit_btn">
							</div>
						</div>
