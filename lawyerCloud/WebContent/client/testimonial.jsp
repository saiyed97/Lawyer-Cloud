		...
		<div class="container">
			<div class="row">
				...
				<div class="lw_contact_form">
					...
					<form method="post" action="<%=request.getContextPath()%>/TestimonialController">						
						
													
						<div class="col-lg-12 col-md-12 col-sm-12">
						 <textarea name="testimonialDescription" class="contact_textarea" placeholder="Testimonial Description*" required id="mesg"></textarea>
						</div>		
	
						<input type="hidden" name="flag" value="insertTestimonial">
						
						
						<div class="col-lg-6 col-md-6 col-sm-6" style="margin-bottom: 4%">
